...
# Simple daily backup template.
# Override these values with environment variables instead of editing the script.
backup_path="${BACKUP_PATH:-/seu/diretorio}"
external_storage="${EXTERNAL_STORAGE:-/mnt/backup}"
log_file="${LOG_FILE:-/var/log/daily-backup.log}"
